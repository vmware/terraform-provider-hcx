---
page_title: "HCX/VMC Lab - OnPrem to Cloud AND Cloud to Cloud Setup"
---

This TF file automates the configuration of a HCX setup. It manages creation/update/deletion of :
...
// Provider config - This cloud is HCX-C2C-1
provider hcx {
    hcx         = "https://hcx.sddc-18-135-22-243.vmwarevmc.com"
